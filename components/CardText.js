...
const CardText = () => {
  return (
    <>
      <div className="main lg:max-w-[50%]  bg-transparent">
        <h2 class="text-[#0073e6] mb-2 text-sm w-[50%] font-">
          Component library
        </h2>
        <h2 class="text-[2.2rem] leading-10 font-bold text-gray-900">
        ...
        <div className="btn flex flex-wrap gap-2">
          <Button
            ...
            customClass={`bg-white border border-[#0073e6] lg:w-[40%] rounded-xl h-12 !justify-start !text-gray-800 gap-4 !text-sm`}
            text={"Button"}
          />
          <Button
            svgIcon={
            ...
            customClass={`bg-white border border-gray-200 lg:w-[40%] rounded-xl h-12 !justify-start !text-gray-800 gap-4 !text-sm`}
            text={"Button"}
          />
          <Button
            svgIcon={
          ...
          <Button
            ...
            text={"Tooltip"}
            customClass={`bg-white border-2 border-dashed border-gray-200 hover:border-[#0073e6] lg:w-[40%] rounded-xl h-12 !justify-start !text-gray-800 gap-4 !text-sm`}
          />
        </div>
      </div>
    </>
