...
const CardText = () => {
  return (
    <>
      <div className="main w-[100%] lg:max-w-[50%]  bg-transparent">
        ...
        <div className="btn flex overflow-scroll lg:flex-wrap gap-2">
          <Button
            svgIcon={
              <svg
            ...
            customClass={`bg-white border border-[#0073e6] min-w-[70%]  lg:min-w-[40%] rounded-xl h-12 !justify-start !text-gray-800  gap-2 lg:gap-4 !text-sm flex-col !items-start h-16 lg:item-center sm:flex-row`}
            text={"Button"}
          />
          <Button
            svgIcon={
            ...
            customClass={`bg-white min-w-[70%]  lg:min-w-[40%] rounded-xl h-12 !justify-start !text-gray-800  gap-2 lg:gap-4 !text-sm flex-col !items-start h-16 lg:item-center sm:flex-row`}
            text={"Button"}
          />
          <Button
            svgIcon={
          ...
          <Button
            ...
            text={"Tooltip"}
            customClass={`bg-white border-2 border-dashed border-gray-200 hover:border-[#0073e6] min-w-[70%]  lg:min-w-[40%] rounded-xl h-12 !justify-start !text-gray-800  gap-2 lg:gap-4 !text-sm flex-col !items-start h-16 lg:item-center sm:flex-row`}
          />
