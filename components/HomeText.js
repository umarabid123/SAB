const HomeText = () => {
  return (
    <div className="main max-w-[1200px] mx-auto flex  pt-10">
      <div className="left-side max-w-[20%]">
        ...
        <div className="heading-txt">
          ...
          <div className="btn flex items-center gap-3">
            <button className="bg-[#0073e6] text-[#fff] text-md font-semibold rounded-md flex gap-1 w-[24%] items-center justify-center px-3 py-3">
              Get started
              <svg
                className="w-[20%]"
                focusable="false"
            ...
            <button className="bg-[#fff] border border-gray-300 shadow-sm text-[#000] text-md font-semibold rounded-md flex gap-1 w-[31%] items-center justify-center px-3 py-2">
              View templates
              <svg
                className="w-[20%]"
                focusable="false"
      ...
      <div className="right-side bg-[#ebf5ff] p-6 intial max-w-4xl">
        <div className="bar bg-[#fff] p-4 mb-8 flex items-center">
         <div className="item flex items-center gap-2 w-[40%]">
         <svg
          ...
          <span class="text-black text-sm font-semibold">Search for React UI libraries</span>
      <div className="w-[23%] !border-b-[1px] border-[#b6bce9]" />
        </div>
        <div className="item flex items-center gap-3">
         <svg
            class="!fill-[#006bd6] w-[5%]"
            focusable="false"
            aria-hidden="true"
            viewBox="0 0 24 24"
            data-testid="CheckCircleIcon"
          ...
          <span class="text-black text-sm font-semibold">Spot Material UI</span>
