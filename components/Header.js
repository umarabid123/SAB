            ...
            <div className="relative">
              <div className="text w-[36%] flex flex-col gap-2 sm:gap-6 absolute left-[4%] top-[50%]">
                ...
                <div className="btn flex items-center gap-2">
                  ...
                  <button className="bg-black lg:w-[42%] xl:w-[32%] h-[30px] sm:h-[40px] rounded-[4px] flex items-center gap-2 py-[6px] pr-[15px] pl-[12px] sm:py-[9px] sm:pr-[26px] sm:pl-[22px]">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                ...
                <div className="text-[14px] font-[500] mt-[40px] text-[#fff]">
