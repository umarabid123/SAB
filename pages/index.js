  ...
  const svgCard = [
    {
      svg: <svg
        ...
        height="190"
        viewBox="-20 0 70 154"
        className="svg-icon svg-icon-rank-1 top-10-rank h-[156px] sm:h-[190px]"
      >
        <path
          stroke="#595959"
    ...
    },
    {
      svg: <svg
        ...
        height="190"
        viewBox="0 0 80 154"
        className="svg-icon svg-icon-rank-2 top-10-rank h-[156px] sm:h-[190px]"
      >
        <path
          stroke="#595959"
          strokeLinejoin="square"
    ...
    },
    {
      svg: <svg
        ...
        height="190"
        viewBox="0 0 80 154"
        className="svg-icon svg-icon-rank-3 top-10-rank h-[156px] sm:h-[190px]"
      >
        <path
          stroke="#595959"
          strokeLinejoin="square"
    ...
    },
    {
      svg: <svg
        ...
        height="190"
        viewBox="0 0 81 154"
        className="svg-icon svg-icon-rank-4 top-10-rank h-[156px] sm:h-[190px]"
      >
        <path
          stroke="#595959"
          strokeLinejoin="square"
    ...
    },
    {
      svg: <svg
        ...
        height="190"
        viewBox="0 0 81 154"
        className="svg-icon svg-icon-rank-5 top-10-rank h-[156px] sm:h-[190px]"
      >
        <path
          stroke="#595959"
          strokeLinejoin="square"
    ...
    },
    {
      svg: <svg
        ...
        height="190"
        viewBox="0 0 81 154"
        className="svg-icon svg-icon-rank-6 top-10-rank h-[156px] sm:h-[190px]"
      >
        <path
          stroke="#595959"
          strokeLinejoin="square"
...

    {
      svg: <svg
        ...
        width="140"
        height="190"
        className="svg-icon svg-icon-rank-7 top-10-rank h-[156px] sm:h-[190px]"
      >
        <path
          stroke="#595959"
          strokeWidth="4"
...

    {
      svg: <svg
        ...
        height="190"
        viewBox="0 0 77 154"
        className="svg-icon svg-icon-rank-8 top-10-rank h-[156px] sm:h-[190px]"
      >
        <path
          stroke="#595959"
          strokeLinejoin="square"
    ...
    },
    {
      svg: <svg
        ...
        width="170"
        height="190"
        className="svg-icon svg-icon-rank-9 top-10-rank h-[156px] sm:h-[190px]"
      >
        <path
          stroke="#595959"
          strokeWidth="4"
    ...
    <div className="overflow-hidden">
      ...
      <div className="card-container bg-[#141414] h-[200vh] pb-[50px]">
        <div className="cards flex">
          ...
          {data.map((item, index) => <Card item={item} key={Math.random()} />)}



        </div>
        <div className="pak-movies my-[3vw] h-[22%] sm:w-[40%]">
          <p className="text-[16px] text-[#fff] mb-[10px] font-[700] my-[0.4%] ml-[3rem]">
            Top 10 Movies in Pakistan Today
          </p>
          <div className="all-num-card flex gap-4 pl-[4%] mt-[10px] w-[100vw]">
            {svgCard.map((items, index) => <SvgCard items={items} key={Math.random()}  />)}
          </div>
        </div>
