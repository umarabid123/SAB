  ...
  return (
    <>
      <div className="main mx-auto">
        ...
        <p className="text-sm lg:w-[30%] text-center text-gray-600">The world's best product teams trust MUI to deliver an unrivaled experience for both developers and users.</p>
        </div>
        </div>
        <hr />
        <Card />
