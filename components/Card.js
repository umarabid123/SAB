  ...
  return (
    ...
    <div className={ `main border border-[#f0f0fd] w-full lg:max-w-[50%] h-fit rounded-md bg-[#f0f0fd]`}>
      ...
      <Button
        ...
        text={"ADD ITEM"}
        customClass={`lg:w-[27%] lg:h-12 bg-white !text-[#0073e6] text-sm`}
        />
        <Button
          svgIcon={
            <svg
        ...
        text={"ADD ITEM"}
        customClass={`lg:w-[27%] lg:h-12 text-sm`}
        />
         <Button
          svgIcon={
            <svg
        ...
        text={"ADD ITEM"}
        customClass={`lg:w-[27%] lg:h-12 bg-white !text-[#0073e6] border border-[#0073e6] text-sm`}
        />
      </div>
