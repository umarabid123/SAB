    ...
    <>
      ...
      <div
         ...
         onMouseLeave={handleMouseLeave} className={
          " flex flex-col min-w-[47%] overflow-x-hidden sm:min-w-[33%] lg:min-w-[23%] xl:min-w-[19%] max-w-[28%] transition-all  hover:z-50 duration-500 ease-in-out  hover:scale-125  relative box-border p-0 m-0"
        }
      >
        <div className=".img-s relative w-[100%]">
          ...
          <p className="text-[#fff] bg-red-600 inline-block p-[2px] absolute bottom-0 left-14 sm:left-20 2xl:left-[100px] text-center rounded-t-[4px] text-[8px] sm:text-[10px] lg:text-[10px] font-[700] w-[40%] group-hover:left-24">
            Recently Added
          </p>
        </div>
        ...
        { isHovered && (<div className="all h-36 z-[9999px]  bg-[#141414] rounded-xl transition-all duration-500 px-2">
          <div className=" flex justify-between items-center py-2 transition-all duration-500 delay-500">
            <div className="img-logo flex items-center gap-2">
              <img
                src="/images/liked.png"
                className="w-[12%] border-[1px] rounded-full p-[6px] border-[#dbd0d0]"
              />
              <img
                src="/images/plus.png"
                className="w-[13%] rounded-full border-[#dbd0d0]"
              />
            </div>
            ...
            <div className="bottom-txt flex items-center gap-3 text-[14px]">
              <p className=" font-medium text-green-500">New</p>
              <p className="border-[1px] border-gray-500 text-gray-500 px-1 py-0 text-[12px]">17+</p>
              <p className="text-gray-400">1h 36m</p>
              <p className="border-[1px] border-gray-500 text-gray-500 px-2 py-0 rounded-[4px] text-[10px]">HD</p>
            </div>
          <div className="bottom-txt-2 text-[14px]">
