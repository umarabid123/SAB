              ...
              <div className={" .svg-card-img relative hover:z-50" }>
                <img
                 onClick={(e) => {
                  ...
                  src={items.img}
                  alt=""
                  className="h-[76%] md:h-[87%] lg:h-[84%] xl:h-[76%] 2xl:h-[64%] w-[100%] relative"
                />
                <img
                  src="/images/icon-top10.png"
                  className="w-[20%] absolute top-0 right-0"
                />
                <p className="text-[#fff] bg-red-600 inline-block p-[2px] absolute bottom-[40px] md:bottom-[29px] lg:bottom-[35px] xl:bottom-[60px] 2xl:bottom-[105px] left-4 2xl:left-5 text-center rounded-t-[4px] text-[8px] font-[700] w-[74%]">
                  Recently Added
                </p>
              </div>
              { isHovered && (
